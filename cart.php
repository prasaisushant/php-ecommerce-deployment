...
if ($cart_count > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<h4 style='color: white;'>{$name}</h4>"; // White text color
        echo "</div>";
        ...
        echo "<h4 style='color: white;'>Rs " . number_format($price, 2, '.', ',') . "</h4>"; // White text color
        echo "</div>";
        echo "</div>";
    ...
    echo "<div class='col-md-4'>";
    echo "<div class='cart-row'>";
    echo "<h4 class='m-b-10px' style='color: white;'>Total ({$item_count} items)</h4>"; // White text color
    echo "<h4 style='color: white;'>Rs " . number_format($total, 2, '.', ',') . "</h4>"; // White text color
